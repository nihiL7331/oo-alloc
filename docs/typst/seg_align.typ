...
#stack(dir: ttb, spacing: 20pt, stack(
  ...
  mem-block(40pt, col-free, "pad", subtext: "align"),
  mem-block(tag-w, col-offset, "off", subtext: "1"),
  mem-block(90pt, col-used, "data 1", subtext: "void* ptr|sz:72"),
