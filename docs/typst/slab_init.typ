...
#stack(
  dir: ltr,
  mem-block(120pt, col-header, "slab header", subtext: "id: 0x51AB | used: 0"),
  mem-block(80pt, col-free, "slot 0", subtext: "head | nxt: 1"),
  mem-block(80pt, col-free, "slot 1", subtext: "next: slot 2"),
  mem-block(80pt, col-free, "slot 2", subtext: "next: slot 3"),
